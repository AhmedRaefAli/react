...
// here we animate based on scroll
export default function WelcomePage() {
  const { scrollY } = useScroll(); // get the value of scroll on y or x axis

  const yCity = useTransform(scrollY, [0, 200], [0, -100]); // transform the scroll value to animate value if scroll 200 pixel animate to -100 opacity or position as you set
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{ opacity: opacityCity, y: yCity }} // used by style prop as that 
          src={cityImg}
